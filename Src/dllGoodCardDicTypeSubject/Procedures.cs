...
namespace dllGoodCardDicTypeSubject
{
    class Procedures : SqlProvider
    {
        ...
        public async Task<DataTable> setSubject(int id, string cName,string code,  bool isActive, bool isDel, int result,bool isAutoIncriments)
        {
            ap.Clear();
            ap.Add(id);
            ap.Add(cName);
            ...
            DataTable dtResult = executeProcedure("[Goods_Card_New].[spg_setSubject]",
                 new string[8] { "@id", "@cName","@code", "@isActive", "@id_user", "@result", "@isDel","@isAutoIncriments" },
                 new DbType[8] { DbType.Int32, DbType.String, DbType.String, DbType.Boolean, DbType.Int32, DbType.Int32, DbType.Boolean, DbType.Boolean }, ap);
